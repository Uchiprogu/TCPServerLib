...
setup_tcp_communication(){
    ...
    std::cout << "addr "  << network_convert_ip_n_to_p((dest.sin_addr.s_addr), nullptr) << std::endl;
    std::cout << "port "  <<dest.sin_port << std::endl;
    std::cout << "sin_zero "  <<dest.sin_zero << std::endl;
    std::cout << "sin_family "  <<dest.sin_family << std::endl;
